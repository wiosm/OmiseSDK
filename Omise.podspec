#
#  Be sure to run `pod spec lint Omise.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Nhat Khanh Do" => "nhatkhanh.do@ascendcorp.com" }
  # Or just: spec.author    = "Nhat Khanh Do"
  # spec.authors            = { "Nhat Khanh Do" => "nhatkhanh.do@ascendcorp.com" }
  # spec.social_media_url   = "https://twitter.com/Nhat Khanh Do"
